...
def CRM_upload_template():
    ...
    df_template.loc[:,'Address_Type'] = 'Residential'
    df_template.loc[:,'Address_Tag'] = 'Primary'
    ...
    if Co_borrower == 'yes':
        ...
        df_template.loc[:, 'Co-Borrower Address_Type'] = 'Residential'
        df_template.loc[:, 'Co-Borrower Address_Tag'] = 'Primary'
    ...
    if Guarantor == 'yes':
        ...
        df_template.loc[:, 'Guarantor Address_Type'] = 'Residential'
        df_template.loc[:, 'Guarantor Address_Tag'] = 'Primary'
